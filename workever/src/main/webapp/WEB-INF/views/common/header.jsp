...
<body>
	...
	<nav class="main-header navbar navbar-expand navbar-white navbar-light">
	  ...
	  <ul class="navbar-nav ml-auto">
	    ...
	    <li class="nav-item dropdown">
		      <a class="nav-link" data-toggle="dropdown" id="alertBtn">
		        <i class="far fa-bell"></i>
		        <span class="badge badge-warning navbar-badge" id="alertCount"></span>
		      </a>
		      
		      <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="overflow-x:hidden;height:300px;" id="alertDropdown">
