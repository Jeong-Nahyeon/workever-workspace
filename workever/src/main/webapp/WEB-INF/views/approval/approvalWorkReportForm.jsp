		...
		<c:when test="${ empty param }">
		    <table border>
		        ...
		        <tr>
		            ...
		            <td width="170" colspan="2">&nbsp;&nbsp;&nbsp;<input type="text" id="workDate" name="workDate" required></td>
		        </tr>
		        <tr>
		...
		<c:otherwise>
		    <table border>
		        ...
		        <tr>
		            ...
		            <th width="150">기안일</th>
		            <td width="170">&nbsp;&nbsp;&nbsp;${ param.apvlCreateName }</td>
		        </tr>
		        <tr>
		            <th width="150">업무명</th>
		            <td width="170" colspan="2"><input type="text" size="45" name="workName" value="${ param.workName }" required></td>
		            <th width="150">시행 일자</th>
		            <td width="170" colspan="2">&nbsp;&nbsp;&nbsp;<input type="text" id="workDate" name="workDate" value="${ param.workDate }" required></td>
		        </tr>
		        <tr>
		            <th colspan="6" >업무 계획</th>
		        </tr>
		        <tr>
		            <td colspan="6">
		                <textarea id="content" rows="20" style="resize:none;" name="workPlan" required>${ param.workPlan }</textarea>
		            </td>
		        </tr>
		    </table>
