				...
				<div id="inner-area">
	                <table border>
				        ...
				        <tr>
				            ...
				            <th width="150">기안일</th>
				            <td width="170">&nbsp;&nbsp;&nbsp;${ apvl.apvlCreateDate }</td>
				        </tr>
				        <tr>
				            <th width="150">출장지</th>
				            <td width="170">&nbsp;&nbsp;&nbsp;${ form.btPlace }</td>
				            <th width="150">출장 시작일</th>
				            <td width="170">&nbsp;&nbsp;&nbsp;${ form.btStartDate }</td>
				            <th width="150">출장 종료일</th>
				            <td width="170">&nbsp;&nbsp;&nbsp;${ form.btEndDate }</td> 
				        </tr>
				        <tr>
				            <th>출장 여비</th>
				            <td colspan="5">&nbsp;&nbsp;&nbsp;<fmt:formatNumber value="${ form.btExpense }"/>원</td>
				        </tr>
				        <tr>
