		...
		<c:when test="${ empty param }">
		    <table border>
		        ...
		        <tr>
		            ...
		            <th>연장 근무 일자</th>
		            <td><input type="text" id="otDate" size="15" name="otDate" required></td>
		            <th>연장 시간</th>
		...
		<c:otherwise>
		    <table border>
		        ...
		        <tr>
		            ...
		            <th width="130">기안일</th>
		            <td width="230">&nbsp;&nbsp;&nbsp;${ param.apvlCreateDate }</td>
		        </tr>
		        <tr>
		            <th>업무명</th>
		            <td><input type="text" name="otTitle" value="${ param.otTitle }" required></td>
		            <th>연장 근무 일자</th>
		            <td><input type="text" id="otDate" size="15" name="otDate" value="${ param.otDate }" required></td>
		            <th>연장 시간</th>
		            <td><input type="number" name="otWorkingHours" value="${ param.otWorkingHours }" required>시간</td> 
		        </tr>
		        <tr>
		            <th colspan="6" >사유</th>
		        </tr>
		        <tr>
		            <td colspan="6">
		                <textarea name="otContent" id="content" rows="20" style="resize:none;" required>${ param.otContent }</textarea>
		            </td>
		        </tr>
		    </table>
