...
<body class="hold-transition sidebar-mini">
	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<h3 class="wh_title"><a href="adCommute.wh">월 근무 내역</a></h3>
			...
			<div id="wh_select" style="width: 1000px; margin: auto;">
				<div align="center">
                    ...
                    <input type="text" class="dateInput" style="width: 250px;" placeholder="이름">
			...
			<div class="select-area" style="width: 80%; margin: auto;">
				...
				<table class="table" style="text-align: center;">
				  	<thead>
						...
						<th width="20%">연장 근무시간</th>
						<th width="20%">총 근무시간</th>
						</tr>
				  	</thead>
				  	<tbody>
						<tr>
