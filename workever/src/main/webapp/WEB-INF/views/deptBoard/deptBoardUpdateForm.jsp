...
<body class="hold-transition sidebar-mini">
					...
					<div class="row">
						<div class="col-12">
							<div class="card"> 
								...
								<div class="card-body">
									<form id="board-update-form" action="update.dbo" method="post" enctype="multipart/form-data">
										
										<input type="hidden" name="dbNo" value="${ db.dbNo }" />
										<input type="hidden" name="userNo" value="${ db.userNo }" />
										<input type="hidden" name="deptNo" value="${ db.deptNo }" />
										...
										<table id="board-insert-form">
											<thead>
												...
												<tr>
													<th>제목</th>
													<td colspan="3">
														<input type="text" name="dbTitle" value="${ db.dbTitle }" class="form-control" maxlength="65" required>  
													</td>
												</tr>
												<tr>
													<th>첨부파일</th>
											...
											<tbody>
												<tr align="center">
													<th colspan="4" style="padding:10px;">내용</th>
												</tr>
												<tr>
													<td colspan="4">
														<div class="form-group">
															<textarea id="board-textarea" class="form-control" name="dbContent" required>${ db.dbContent }</textarea>
														</div>
													</td>
												</tr>
											</tbody>
	...
	<!-- 수정할 글이 공지글인 경우 => 카테고리 공지 선택되도록 유지 -->
