	...
	<div class="wrapper">
		...
		<div class="content-wrapper">
			...
			<section class="content-header">
				...
				<div class="row mb-2">
					<div class="col-sm-6">
					<h1 id="page-title">${ deptName } 게시글 작성</h1>
					</div>
				</div>
				</div><!-- /.container-fluid -->
			</section>
					...
					<div class="row">
						<div class="col-12">
							<div class="card"> 
								...
								<div class="card-body">
									<form id="board-enroll-form" action="insert.dbo" method="post" enctype="multipart/form-data">
										...
										<table id="board-insert-form">
											<thead>
												<tr>
													<th>작성자</th>
													<td width="50%">${ loginUser.userName }</td> 
													<th>카테고리</th>
												<td>
												...
												<tr>
													<td colspan="4">
														<div class="form-group">
															<textarea id="board-textarea" class="form-control" name="dbContent" required></textarea>
														</div>
													</td>
												</tr>
											</tbody>
